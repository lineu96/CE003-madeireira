...
DT::datatable(notas[,c('GRR', 'FALTAS', 'S1', 
                       'S2', 'S3', 'S4', 'P1')], class = 'cell-border stripe',
              rownames = F,
              #filter = 'top',
              editable = T
              )
...
p1 = ggplot(notas) + 
  geom_histogram(aes(x=S2,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1,
                 breaks = seq(0,10,0.5)) + 
  geom_density(aes(x=S2,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  ylab("Densidade") +
...
<center>
```{r, echo=FALSE}
pander::pander(posicao(notas$S3))
```
</center>
...
p1 = ggplot(notas) + 
  geom_histogram(aes(x=S3,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1,
                 breaks = seq(0,10,0.5)) + 
  geom_density(aes(x=S3,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  ylab("Densidade") +
...
<center>
```{r, echo=FALSE}
pander::pander(posicao(notas$S4))
```
</center>
...
p1 = ggplot(notas) + 
  geom_histogram(aes(x=S4,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1,
                 breaks = seq(0,10,0.5)) + 
  geom_density(aes(x=S4,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  ylab("Densidade") +
